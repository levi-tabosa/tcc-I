        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="flex items-center gap-3 mb-3">
            <div class="p-2 rounded-lg bg-purple-500/15">
              <Landmark class="h-6 w-6 text-purple-500" />
            </div>
          ...
          <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              ...
              <p class="mt-2 text-muted-foreground max-w-2xl">
                Explore as comissões permanentes e temporárias do Senado Federal. Saiba quem são os membros, presidentes e relatores de cada uma.
              </p>
            </div>
            <!-- Filtro de tipo -->
            ...
            <BaseCard hover>
              <div class="flex items-center gap-4">
                <div class="p-3 rounded-xl bg-purple-500/10">
                  <LayoutGrid class="h-6 w-6 text-purple-500" />
                </div>
                <div>
      ...
      <section class="py-8">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div v-else class="space-y-3">
            ...
            >
              <div class="flex items-center gap-4">
                <div class="flex-shrink-0 w-14 h-14 rounded-xl bg-purple-500/10 flex items-center justify-center overflow-hidden p-1">
                  <span class="text-[10px] font-bold text-purple-500 text-center leading-tight break-all line-clamp-3">{{ comissao.sigla }}</span>
                </div>
                ...
                <div v-if="selectedComissao?.id === comissao.id" class="mt-4 pt-4 border-t border-border">
                  ...
                  <div v-if="comissao.membros?.length" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                    ...
                    >
                      ...
                      <div class="min-w-0">
                        <p class="text-xs font-medium text-foreground truncate group-hover:text-purple-500 transition-colors">{{ membro.nome }}</p>
...
onMounted(async () => {
  ...
  try {
    const res = await fetch(`${apiUrl}/api/senado/comissoes`)
