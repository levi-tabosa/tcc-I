    ...
    <main class="flex-1">
      <section class="bg-gradient-to-br from-primary/10 via-background to-accent/10 py-12">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold text-foreground sm:text-4xl">Comissões da Câmara</h1>
          <p class="mt-2 text-muted-foreground max-w-2xl">
            Consulte a composição, presidência e membros das comissões permanentes e temporárias da Câmara dos Deputados.
          </p>
        </div>
      </section>
